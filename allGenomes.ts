...
import Oryza_sativa from './Oryza_sativa/Oryza_sativa' 
...
export const treeOfLife: {[speciesName: string]: SpeciesConfig} = {
    ...
    Oryza_sativa:{
        logoUrl: 'https://github.com/happyfantongzi/washU/blob/master/Os.jpg',
	assemblies:[ Oryza_sativa.genome.getName() ],
	color: 'white',
    }
};
